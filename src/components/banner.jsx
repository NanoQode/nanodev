...
const Banner = () => {
  return (
    <div className=' flex flex-col sm:flex-row justify-between'>
      <section className='w-full lg:w-3/4 xl:w-1/2'>
        ...
        <div className='flex items-center space-x-2 ml-10'>
          ...
          <button className='text-[#DA452C] border-[#DA452C] border-2  rounded-lg bg-transparent bg-[#5AA6B1] p-2 lg:p-4 text-sm'>BOOK A FREE CONSULT</button>
        </div>
        <div className='ml-1 -mt-20'>
          <img src={scrolll} className='' alt="" />
        </div>
      </section>
      <section className='w-full lg:w-3/4 xl:w-1/2 flex items-center mb-7 justify-center flex-col lg:-mt-20 xl:-mt-3'>
        <img src={banner} alt="" />
        <img src={loading} alt="" />
