...
const ServicesFeatures = ({ color, data, bgColor }) => {
    return (
        <section style={{ backgroundColor: bgColor }} className='nc-features w-full h-max relative py-16'>
            ...
            <div className='hidden sm:flex absolute  left-0 top-[10rem] mlg:hidden'>
                <img src={FEATURES} alt="" />
            </div>
            <div className='pt-10'>
                <div className='container mx-auto'>
                    <div className='flex items-center justify-center flex-col lg:grid lg:grid-cols-2 mlg:grid-cols-2 bg-[#E9E9E9] w-max gap-10 p-8 h-max mx-auto mlg:w-full xl:p-10 '>
                        {data.map((item) =>
