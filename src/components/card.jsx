...
const Card = ({ title, img,body }) => {
  return (
    <div className={`w-[300px] mt-16 p-6 flex
 flex-col   bg-[#5AA6B1] items-center h-[232px]  duration-150 ease-out transistion-all justify-center cursor-pointer hover:bg-[#DA4B27]`} >
