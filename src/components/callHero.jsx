    ...
    return (
        <section className='py-16'>
            <div className='container mx-auto'>
                <div className='flex  flex-wrap pl-5 sm:items-center sm:flex-row sm:justify-between sm:py-5 sm:px-10 lg:py-10 lg:px-20 p-5 min-h-[260px] mxs:min-h-[0px] rounded' style={{
