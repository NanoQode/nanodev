...
const ServiceCard = ({ data, color }) => {
    return (
        <div className='service-card bg-white relative w-[440px] xl:w-[440px] mlg:w-full shadow-sm xl:h-[202px] py-7 pl-14 pr-10 hover:bg-[#5AA6B1] hover:!text-white my-5  hover:scale-105 duration-150 ease-out transition-all cursor-pointer'>
