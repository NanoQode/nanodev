  ...
  return (
      <div className='bg-[#DA4B271F] p-4'>
          ...
          <section className='flex my-20 items-center justify-center flex-col lg:flex-row sm:ml-32 relative 2xl:max-w-7xl 2xl:mx-auto'>
              <div className={'hidden sm:absolute -left-24 lg:-left-10 xl:left-16 sm:flex' }>
                  <img src={img} alt="" />
              </div>
              <div className='flex relative w-full lg:w-[60%] xl:w-1/2 '>
                  <div className='mt-4 sm:mt-0 sm:-ml-32 bg-[#E9E9E9] w-[524px] h-max flex items-center flex-col space-y-4 p-6 relative z-30'>
                      {data.map((item) =>
                          <div key={item.id}
                              className='m-4 bg-white p-4 flex items-center space-x-5 hover:bg-[#BAE3E9] w-[300px] duration-150 transition-all hover:shadow-xl hover:scale-105 ease-out rounded-md'>
