        ...
        <section className='bg-[#DA4B271F] pt-14'>
            ...
            <main className='xl:mx-24 2xl:max-w-7xl 2xl:mx-auto'>
                ...
                <div className='flex ml-0 mt-14 items-start w-full flex-wrap relative'>
                    <div className='flex relative w-full  lg:w-1/2  mmd:w-100'>
                        <div className='seo-text  absolute '>
                            <h3 className='text-white font-bold font-inter uppercase '>SEO</h3>
                        </div>
                        <div className='mt-4 pb-10 mb-7 sm:mt-0 ml-auto  bg-[#E9E9E9] w-[524px] h-max flex   flex-col space-y-4 p-6 relative z-30 mxss:py-3  mxss:px-0' >
                            {data.map((item) =>
                                <div key={item.id}
                    ...
                    <div className='hidden sm:flex sm:ml-0 w-[625px] mxl:w-[500px] max-w-[50%] mmd:max-w-[100%]  mt-16 mmd:w-100 mmd:mt-0'>
                        <Swiper
